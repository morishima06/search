                    ...
                    <div class="flex items-center ">
                        <div class="md:ml-3 my-2 w-full">
                            <select name="sex" class="inline-block w-full md:w-60  my-2  border border-gray-300 rounded-sm focus:border-none ">
                                <option value="" <?php if ($userdetail->sex == "") {
                                                        echo 'selected="selected"';
                                                    } ?>>選択してください</option>
                                <option value="男性" <?php if ($userdetail->sex == "男性") {
                                                        echo 'selected="selected"';
                                                    } ?>>男性</option>
                                <option value="女性" <?php if ($userdetail->sex == "女性") {
                                                        echo 'selected="selected"';
                                                    } ?>>女性</option>
                                <option value="その他" <?php if ($userdetail->sex == "その他") {
                                                        echo 'selected="selected"';
                                                    } ?>>その他</option>
                            </select>
                        </div>
                ...
                <div class="md:flex border-b border-slate-300 ">
                    ...
                    <div class="md:ml-3 my-2  ">
                        ...
                        <select name="pref" class="w-full md:w-60 pref px-2 border-slate-300">
                            <option value="" <?php if ($userdetail->pref == "") {
                                                    echo 'selected="selected"';
                                                } ?>>選択してください</option>
                            <option value="1" <?php if ($userdetail->pref == "1") {
                                                    echo 'selected="selected"';
                                                } ?>>北海道</option>
                            <option value="2" <?php if ($userdetail->pref == "2") {
                                                    echo 'selected="selected"';
                                                } ?>>青森県</option>
                            <option value="3" <?php if ($userdetail->pref == "3") {
                                                    echo 'selected="selected"';
                                                } ?>>岩手県</option>
                            <option value="4" <?php if ($userdetail->pref == "4") {
                                                    echo 'selected="selected"';
                                                } ?>>宮城県</option>
                            <option value="5" <?php if ($userdetail->pref == "5") {
                                                    echo 'selected="selected"';
                                                } ?>>秋田県</option>
                            <option value="6" <?php if ($userdetail->pref == "6") {
                                                    echo 'selected="selected"';
                                                } ?>>山形県</option>
                            <option value="7" <?php if ($userdetail->pref == "7") {
                                                    echo 'selected="selected"';
                                                } ?>>福島県</option>
                            <option value="8" <?php if ($userdetail->pref == "8") {
                                                    echo 'selected="selected"';
                                                } ?>>茨城県</option>
                            <option value="9" <?php if ($userdetail->pref == "9") {
                                                    echo 'selected="selected"';
                                                } ?>>栃木県</option>
                            <option value="10" <?php if ($userdetail->pref == "10") {
                                                    echo 'selected="selected"';
                                                } ?>>群馬県</option>
                            <option value="11" <?php if ($userdetail->pref == "11") {
                                                    echo 'selected="selected"';
                                                } ?>>埼玉県</option>
                            <option value="12" <?php if ($userdetail->pref == "12") {
                                                    echo 'selected="selected"';
                                                } ?>>千葉県</option>
                            <option value="13" <?php if ($userdetail->pref == "13") {
                                                    echo 'selected="selected"';
                                                } ?>>東京都</option>
                            <option value="14" <?php if ($userdetail->pref == "14") {
                                                    echo 'selected="selected"';
                                                } ?>>神奈川県</option>
                            <option value="15" <?php if ($userdetail->pref == "15") {
                                                    echo 'selected="selected"';
                                                } ?>>新潟県</option>
                            <option value="16" <?php if ($userdetail->pref == "16") {
                                                    echo 'selected="selected"';
                                                } ?>>富山県</option>
                            <option value="17" <?php if ($userdetail->pref == "17") {
                                                    echo 'selected="selected"';
                                                } ?>>石川県</option>
                            <option value="18" <?php if ($userdetail->pref == "18") {
                                                    echo 'selected="selected"';
                                                } ?>>福井県</option>
                            <option value="19" <?php if ($userdetail->pref == "19") {
                                                    echo 'selected="selected"';
                                                } ?>>山梨県</option>
                            <option value="20" <?php if ($userdetail->pref == "20") {
                                                    echo 'selected="selected"';
                                                } ?>>長野県</option>
                            <option value="21" <?php if ($userdetail->pref == "21") {
                                                    echo 'selected="selected"';
                                                } ?>>岐阜県</option>
                            <option value="22" <?php if ($userdetail->pref == "22") {
                                                    echo 'selected="selected"';
                                                } ?>>静岡県</option>
                            <option value="23" <?php if ($userdetail->pref == "23") {
                                                    echo 'selected="selected"';
                                                } ?>>愛知県</option>
                            <option value="24" <?php if ($userdetail->pref == "24") {
                                                    echo 'selected="selected"';
                                                } ?>>三重県</option>
                            <option value="25" <?php if ($userdetail->pref == "25") {
                                                    echo 'selected="selected"';
                                                } ?>>滋賀県</option>
                            <option value="26" <?php if ($userdetail->pref == "26") {
                                                    echo 'selected="selected"';
                                                } ?>>京都府</option>
                            <option value="27" <?php if ($userdetail->pref == "27") {
                                                    echo 'selected="selected"';
                                                } ?>>大阪府</option>
                            <option value="28" <?php if ($userdetail->pref == "28") {
                                                    echo 'selected="selected"';
                                                } ?>>兵庫県</option>
                            <option value="29" <?php if ($userdetail->pref == "29") {
                                                    echo 'selected="selected"';
                                                } ?>>奈良県</option>
                            <option value="30" <?php if ($userdetail->pref == "30") {
                                                    echo 'selected="selected"';
                                                } ?>>和歌山県</option>
                            <option value="31" <?php if ($userdetail->pref == "31") {
                                                    echo 'selected="selected"';
                                                } ?>>鳥取県</option>
                            <option value="32" <?php if ($userdetail->pref == "32") {
                                                    echo 'selected="selected"';
                                                } ?>>島根県</option>
                            <option value="33" <?php if ($userdetail->pref == "33") {
                                                    echo 'selected="selected"';
                                                } ?>>岡山県</option>
                            <option value="34" <?php if ($userdetail->pref == "34") {
                                                    echo 'selected="selected"';
                                                } ?>>広島県</option>
                            <option value="35" <?php if ($userdetail->pref == "35") {
                                                    echo 'selected="selected"';
                                                } ?>>山口県</option>
                            <option value="36" <?php if ($userdetail->pref == "36") {
                                                    echo 'selected="selected"';
                                                } ?>>徳島県</option>
                            <option value="37" <?php if ($userdetail->pref == "37") {
                                                    echo 'selected="selected"';
                                                } ?>>香川県</option>
                            <option value="38" <?php if ($userdetail->pref == "38") {
                                                    echo 'selected="selected"';
                                                } ?>>愛媛県</option>
                            <option value="39" <?php if ($userdetail->pref == "39") {
                                                    echo 'selected="selected"';
                                                } ?>>高知県</option>
                            <option value="40" <?php if ($userdetail->pref == "40") {
                                                    echo 'selected="selected"';
                                                } ?>>福岡県</option>
                            <option value="41" <?php if ($userdetail->pref == "41") {
                                                    echo 'selected="selected"';
                                                } ?>>佐賀県</option>
                            <option value="42" <?php if ($userdetail->pref == "42") {
                                                    echo 'selected="selected"';
                                                } ?>>長崎県</option>
                            <option value="43" <?php if ($userdetail->pref == "43") {
                                                    echo 'selected="selected"';
                                                } ?>>熊本県</option>
                            <option value="44" <?php if ($userdetail->pref == "44") {
                                                    echo 'selected="selected"';
                                                } ?>>大分県</option>
                            <option value="45" <?php if ($userdetail->pref == "45") {
                                                    echo 'selected="selected"';
                                                } ?>>宮崎県</option>
                            <option value="46" <?php if ($userdetail->pref == "46") {
                                                    echo 'selected="selected"';
                                                } ?>>鹿児島県</option>
                            <option value="47" <?php if ($userdetail->pref == "47") {
                                                    echo 'selected="selected"';
                                                } ?>>沖縄県</option>
                        </select>
                    </div>
