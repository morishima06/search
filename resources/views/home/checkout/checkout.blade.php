...
<div class="flex justify-center">
  <div class="max-w-4xl w-full md:w-2/3 mx-1 md:mx-0  ">
    ...
    <div class=" md:flex w-full mt-10 ">
      ...
      <div class="md:w-1/3">
        ...
        <?php $total = 0 ?>
        <div class=" md:max-h-32 md:overflow-scroll hover:opacity-70">
        ...
        <div class="mt-2">
          ...
          <form action="{{route('pay')}}" method="POST">
            @csrf
            <button class="bg-zinc-900 text-white w-40 mt-2 py-1 px-2 mb-3 "> 会計に進む</a></button>
          </form>
        </div>
      </div>
