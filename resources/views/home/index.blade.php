...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <section class="pt-24  ">
            ...
            <div class="px-3">
                ...
                <h2 class="text-sm  text-slate-600 font-semibold  mb-2 line-through"><a  href="{{route('home')}}"class="  w-full h-wull border-b border-slate-600 pb-1 " href="">全てのブランド</a> </h2>
